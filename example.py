...
out = np.savetxt("wsp_out.txt", dane_raport, delimiter='--- ', fmt = ['%10.3f', '%10.3f', '%10.3f', '%10.5f', '%10.5f', '%10.3f', '%10.3f', '%10.3f', '%10.3f', '%10.3f', '%10.7f', '%10.7f', '%10.7f', '%10.5f', '%10.5f'], header = 'konwersja współrzednych geodezyjnych \\ julia treska \n X [m] --------- Y [m] ------- Z [m] ------- fi [st] ------ lam [st] ---- h [m] ------ x2000 [m] ----- y2000 [m] ----- x92 [m] ------ y92 [m] ------ n --------- e ----------- u ------- elewacja [st] --- azymut [st]')
